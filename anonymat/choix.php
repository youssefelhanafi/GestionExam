...
if (isset($_POST['Validerbtn']))
{
...
else 
  {
  ...
  else
    {
      ...
      <thead>
      <tr>
      <th> Semestre : <?php echo $Semestre; ?> </th>
      <th> Filière : <?php echo $Filiere; ?> </th>
      </tr>
      </thead>
      ...
      { ?>
        ...
        <tr>
        <td> <?php echo $rowMatiere['DesignationModule']; ?> </td>
        <td> <?php echo $rowMatiere['DesignationMatiere']; ?> </td>
        <td> <?php echo $rowMatiere['etat']; ?> </td>
     <?php
     ...
     if ($rowMatiere['etat']==0)
        {
         ...
         ?>
          <td>
           <form action="readf1.php" method="post" enctype="multipart/form-data">
...
//<!-- <input type="hidden" name="nummat" value="<?PHP echo $rowMatiere['NumMatiere'];
        ...
        {?>
          ...
          <td> <button type="button" onclick="window.open('demo\'.php')">Fichier Administration</button></td>
          <td></td>
          <td></td>
          <td></td>   
       ...
       <?php }
        ...
        {?>
          ...
          <td> <button type="button" onclick="window.open('demo\'.php')">Fichier Administration</button></td>
          <td><button type="button" onclick="window.open('demo2\'.php')">Fichier Profs</button></td>
          <td></td>
          <td></td>
       ...
       <?php }
        ...
        {?>
          ...
          <td><button type="button" onclick="window.open('demo\'.php')">Fichier Administration</button></td>
          <td><button type="button" onclick="window.open('demo2\'.php')">Fichier Profs</button></td>
          <td><form method="post" enctype="multipart/form-data" action="uploadf2.php">
        <p>
        ...
        {?>
          ...
          <td><button type="button" onclick="window.open('demo2\'.php')">Fichier Profs</button></td>
          <td>
          <form action="readf2'.php" method="post" enctype="multipart/form-data">
